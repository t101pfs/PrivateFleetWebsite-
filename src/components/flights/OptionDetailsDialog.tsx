...
export function OptionDetailsDialog({ open, onOpenChange, option, optionNumber, showOperator, isConfirmed }: OptionDetailsDialogProps) {
        ...
        <div className="space-y-4">
          ...
          {option.aircraft_notes && (
            <div>
              ...
              <p className="text-sm">{option.aircraft_notes}</p>
            </div>
          )}
