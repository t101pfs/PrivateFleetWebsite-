...
const ACTION_LABELS: Record<string, string> = {
  ...
  flight_feedback_submitted: 'submitted post-flight feedback',
  payment_proof_uploaded:'uploaded the proof of payment',
  client_contract_signed: 'signed the Client Contract',
  availability_confirmed: 'confirmed the aircraft is available',
  option_extended: 'extended the client option by an hour',
  discount_requested: 'asked for a client discount',
  discount_approved: 'approved the client discount',
  discount_rejected: 'rejected the client discount',
  aircraft_unavailable: 'reported the aircraft as not available',
